...
//  io.AddMouseButtonEvent(), io.AddMouseWheelEvent() API (1.87+). 2022-01-17: Inputs: always update_ellipse key mods next and
...
bool ImGui_ImplSDL2_ProcessEvent(const SDL_Event* event)
{
...
#if SDL_VERSION_ATLEAST(2, 0, 18) // If this fails to compile on Emscripten: update_ellipse to latest Emscripten!
  ...
  case SDL_WINDOWEVENT:
  {
    ...
    if (window_event == SDL_WINDOWEVENT_LEAVE) bd->MouseLastLeaveFrame = ImGui::GetFrameCount() + 1;
...
static bool ImGui_ImplSDL2_Init(SDL_Window* window, SDL_Renderer* renderer)
{
  ...
  // Our mouse update_ellipse function expect PlatformHandle to be filled for the main viewport
