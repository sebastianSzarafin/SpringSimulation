...
struct IMGUI_API ImGuiInputTextState
{
    ...
    bool                    SelectedAllMouseLock;   // after a double-click to select all, we ignore further mouse drags to update_ellipse selection
...
struct ImGuiContext
{
    ...
    bool                    NavMousePosDirty;                   // When set we will update_ellipse mouse position if (io.ConfigFlags & ImGuiConfigFlags_NavEnableSetMousePos) if set (NB: this not enabled by default)
